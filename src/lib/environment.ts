...
interface EnvironmentConfig {
    ...
    DISCORD_SERVER_BROWSER_CHANNEL_ID?: string;
    DISCORD_SERVER_COUNT_CHANNEL_ID?: string;
    DISCORD_PLAYER_COUNT_CHANNEL_ID?: string;
    DISCORD_MOD_UPDATES_CHANNEL_ID?: string;
...
export function validateEnvironment(): EnvironmentConfig {
    ...
    return {
        ...
        DISCORD_ADMIN_LOG_CHANNEL_ID: process.env.DISCORD_ADMIN_LOG_CHANNEL_ID,
        DISCORD_SERVER_BROWSER_CHANNEL_ID: process.env.DISCORD_SERVER_BROWSER_CHANNEL_ID,
        DISCORD_SERVER_COUNT_CHANNEL_ID: process.env.DISCORD_SERVER_COUNT_CHANNEL_ID,
        DISCORD_PLAYER_COUNT_CHANNEL_ID: process.env.DISCORD_PLAYER_COUNT_CHANNEL_ID,
        DISCORD_MOD_UPDATES_CHANNEL_ID: process.env.DISCORD_MOD_UPDATES_CHANNEL_ID,
